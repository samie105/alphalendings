...
const MainFAQ = () => {
  ...
  const faqData = [
    {
      question: "How do I qualify for a EmergencyRentalAssistance?",
      answer:
        "To apply for a EmergencyRentalAssistance, you’ll need:\n\n" +
        "- A job or other regular source of income\n" +
        "- A checking or savings account\n" +
        "- A Social Security Number (SSN)\n" +
        "- A valid email address, mailing address, and phone number\n" +
        "- To be at least 18 years old\n\n" +
        "Once you apply for a EmergencyRentalAssistance online, we’ll be able to tell you whether or not you qualify. Please note that there are a few instances where we may need to verify your identity once you’re approved. In that case, you’ll be required to verify your identity with our third-party provider before your loan is funded.",
    },
    {
      question: "Are EmergencyRentalAssistance available in my state?",
      answer:
        "EmergencyRentalAssistances are currently available to residents of the following states:\n\n" +
    ...
    {
      question: "When will I know if my EmergencyRentalAssistance is approved?",
      answer:
    ...
    },
    {
      ...
      answer:
        "You have three days from the date you receive your funds to return the funds at no cost to you. Simply contact us at (888) 681-6811 or help@EmergencyRentalAssistance.com to begin the process. Be sure to contact us during business hours before your three-day rescission period comes to an end.",
    },
    {
      question: "What is the interest on a EmergencyRentalAssistance?",
      answer:
        "APR\n" +
        ...
        "For example, on your first EmergencyRentalAssistance, your APR is 490%. If you borrow $600 and choose a bi-weekly payment schedule of ten payments over five months, then you would pay approximately $775 in finance charges, for a total payback of $1,375. (This assumes that your first payment occurs 14 days after the loan is funded, and you make all scheduled payments in full and on time.)",
    },
    {
      question: "What fees are associated with a EmergencyRentalAssistance?",
      answer:
        "There are no hidden fees associated with a EmergencyRentalAssistance. The fees that you are responsible for are outlined when you apply for a EmergencyRentalAssistance and in your loan documents.\n\n" +
        ...
        "Additionally, you may be charged $10 for any returned checks as an NSF fee. EmergencyRentalAssistance does not charge an origination fee.",
    },
    {
      question: "How do EmergencyRentalAssistances compare to payday loans?",
      answer:
        "EmergencyRentalAssistances and payday loans are completely different. EmergencyRentalAssistances are short-term installment loans, which means you pay back your loan over time. With a EmergencyRentalAssistance, you choose how long you want to pay the loan back, up to ten months. Plus, you can pay your loan off early with no prepayment penalties.\n\n" +
    ...
    {
      question:
        "How do I decide if a EmergencyRentalAssistance is right for me?",
      answer:
        "Only you can decide if a EmergencyRentalAssistance is right for you.\n\n" +
        "It is important to note that a EmergencyRentalAssistance is an expensive form of credit and is intended only for short-term financial needs. EmergencyRentalAssistances are designed to help you deal with emergencies such as rent, medical bills, car repairs, and expenses related to your job. EmergencyRentalAssistances are not intended to solve longer-term credit or other financial needs, and alternative forms of credit may be better for you, including borrowing from a friend or relative, using a credit card cash advance, taking out a personal loan, or using a home equity loan or savings.",
    },
    {
      ...
      answer:
        ...
        "97% of EmergencyRentalAssistance customers choose to make their payments using ACH because it is a convenient way to make loan payments, and it can also save you money over the life of your loan by helping you avoid missed payments.\n\n" +
    ...
    {
      question: "How do I contact EmergencyRentalAssistance?",
      answer:
        "That’s easy! Send an email to contact@EmergencyRentalAssistance.com. Our hours of operation are: Monday - Friday 7 a.m. - 8 p.m. CT and Saturday 9 a.m. - 6 p.m. CT.",
    },
    {
      question: "What happens if my loan doesn’t go to the right bank account?",
      answer:
        "We deposit your loan using the bank account information you provided us during the application process. When you make us aware that funds have not been received, it takes five to seven business days for a bank to return the funds to EmergencyRentalAssistance so we can deposit the funds into the correct account.",
    },
    {
